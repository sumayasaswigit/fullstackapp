pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://107.20.11.104:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/sumayasaswigit/fullstackapp.git'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://107.20.11.104:9090/springapp1"
            echo "✅ Frontend deployed: http://107.20.11.104:9090/frontapp1"
        }
        failure {
